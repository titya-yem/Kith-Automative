    ...
    <section className="mb-14 bg-white dark:bg-gray-900">
      <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div className="mr-auto place-self-center lg:col-span-7">
          <h1 className="max-w-2xl text-center lg:text-left mb-4 text-2xl md:text-4xl font-extrabold tracking-tight leading-none dark:text-white">
            We guarantee to get you the best exclusive deal for your luxury
            automation
          </h1>
          <p className="max-w-2xl text-center lg:text-left text-base mb-6 font-light text-gray-500 lg:mb-8 md:text-lg dark:text-gray-400">
